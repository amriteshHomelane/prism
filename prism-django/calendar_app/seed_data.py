...
Loaded into the database by:  python manage.py seed_prism
Pods and participants are upserted every run; sessions are only loaded when the
Session table is empty (so you don't clobber edits). 3 of 6 pods have real data;
the rest are placeholders awaiting their calendars.
"""
...
PARTICIPANTS = {
    ...
    "Foundation (DC)": [
        ...
        "sejal.shubhanand@homelane.com", "sayali.thakur@homelane.com", "pratheeka.k@homelane.com",
        "priti.sutar@homelane.com", "pratiksha.thorat@homelane.com", "kunali.gourigolla@homelane.com",
    ],
    "Dovetail": [
